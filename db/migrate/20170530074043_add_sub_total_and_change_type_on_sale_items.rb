class AddSubTotalAndChangeTypeOnSaleItems < ActiveRecord::Migration[5.0]
  def change
    ...
    change_column :sale_items, :shipping_fee , 'integer USING CAST(shipping_fee AS integer)', default: 0
    change_column :sale_items, :credit_fee , 'integer USING CAST(credit_fee AS integer)', default: 0
